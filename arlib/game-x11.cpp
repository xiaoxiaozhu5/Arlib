...
// for me, there will only be one, so I'll use something simpler than a hashmap
...
#undef ATOM
	...
	XChangeProperty(display, window, atoms._NET_WM_NAME, atoms.UTF8_STRING, 8, PropModeReplace, (uint8_t*)title.ptr_raw(), title.length());
