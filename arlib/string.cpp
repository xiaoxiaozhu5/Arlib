...
extern const uint8_t char_props[256] = {
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0xC0,0x40,0x40,0xC0,0x00,0x00, // 0x
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, // 1x
	0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, // 2x  !"#$%&'()*+,-./
	0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00, // 3x 0123456789:;<=>?
	0x00,0x38,0x38,0x38,0x38,0x38,0x38,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30, // 4x @ABCDEFGHIJKLMNO
	0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x00,0x00,0x00,0x00,0x00, // 5x PQRSTUVWXYZ[\]^_
	0x00,0x38,0x38,0x38,0x38,0x38,0x38,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30, // 6x `abcdefghijklmno
	0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x00,0x00,0x00,0x00,0x00, // 7x pqrstuvwxyz{|}~
...
static bool test_iscspace(uint8_t c) { return test_isspace(c) || c == '\v' || c == '\f'; }
...
test("ctype", "", "string")
{
	for (int i=0;i<=255;i++)
	{
		testctx(tostring(i)) {
			...
			assert_eq(iscspace(i), test_iscspace(i));
